...
IF NOT EXISTS (SELECT 1 FROM msdb.dbo.sysalerts WHERE name='021- Fatal Error in Database Processes')
BEGIN
...
IF NOT EXISTS (SELECT 1 FROM msdb.dbo.sysalerts WHERE name='022- Fatal Error: Table Integrity Suspect')
BEGIN
...
IF NOT EXISTS (SELECT 1 FROM msdb.dbo.sysalerts WHERE name='023- Fatal Error: Database Integrity Suspect')
BEGIN
...
IF NOT EXISTS (SELECT 1 FROM msdb.dbo.sysalerts WHERE name='024- Fatal Error: Hardware')
BEGIN
...
IF NOT EXISTS (SELECT 1 FROM msdb.dbo.sysalerts WHERE name='025- Fatal Error')
BEGIN
...
IF NOT EXISTS (SELECT 1 FROM msdb.dbo.sysalerts WHERE name='823- Read/Write Failure')
BEGIN
...
IF NOT EXISTS (SELECT 1 FROM msdb.dbo.sysalerts WHERE name='824- Data Retriveal SAN Slowdown Page Error')
BEGIN
...
IF NOT EXISTS (SELECT 1 FROM msdb.dbo.sysalerts WHERE name='825- I/O subsystem is going wrong Read-Retry Required')
BEGIN
...
IF NOT EXISTS (SELECT 1 FROM msdb.dbo.sysalerts WHERE name='833- In Memory Check Sum Failure')
BEGIN
